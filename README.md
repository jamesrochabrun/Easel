...
- `Packages/EaselClaudeCodeUI/` contains reusable Codex-first chat UI, storage, runtime, and permission-service integration. Claude and other providers are planned for future support.
